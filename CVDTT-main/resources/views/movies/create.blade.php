                ...
                <div class="card-header bg-white border-bottom-0 rounded-top-4 px-4 py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="mb-0 fw-bold text-primary">
                            <i class="fas fa-film me-2 text-info"></i>Thêm Phim Mới
                        </h3>
                    ...
                    <form action="{{ route('movies.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select shadow-none @error('genre') is-invalid @enderror" id="genre" name="genre" required>
                                        ...
                                        <option value="Tâm lý" {{ old('genre') == 'Tâm lý' ? 'selected' : '' }}>Tâm lý</option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="date" class="form-control shadow-none @error('releaseDate') is-invalid @enderror" 
                                           id="releaseDate" name="releaseDate" value="{{ old('releaseDate') }}" required>
                                    @error('releaseDate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select shadow-none @error('status') is-invalid @enderror" id="status" name="status" required>
                                    ...
                                    <option value="Đang chiếu" {{ old('status') == 'Đang chiếu' ? 'selected' : '' }}>Đang chiếu</option>
                                    <option value="Sắp chiếu" {{ old('status') == 'Sắp chiếu' ? 'selected' : '' }}>Sắp chiếu</option>
                                </select>
                                @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control shadow-none @error('description') is-invalid @enderror" 
                                          ...
                                          placeholder="Nhập tóm tắt nội dung phim" style="resize: vertical; border-radius: 14px;">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex justify-content-end gap-3 mt-5 pt-3 border-top">
                            ...
                            <button type="submit" class="btn btn-primary px-4 py-2 rounded-3 shadow">
                                <i class="fas fa-plus-circle me-2"></i> Thêm phim
                            </button>
                        </div>
                    </form>
                </div>
