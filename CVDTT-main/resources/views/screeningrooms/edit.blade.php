        ...
        <div class="col-12">    
            <div class="card shadow-lg border-0" style="border-radius: 1.5rem;">
                <div class="card-header bg-white border-bottom-0 rounded-top-4 px-4 py-3">
                    <div class="d-flex justify-content-between align-items-center">
                        <h3 class="mb-0 fw-bold text-primary">
                            <i class="fas fa-door-open me-2 text-info"></i>Sửa Phòng Chiếu
                        </h3>
                ...
                <div class="card-body p-4">
                    <form action="{{ route('screeningrooms.update', $screeningroom->roomId) }}" method="POST" class="needs-validation" novalidate>
                        @csrf
                        @method('PUT')
                        <div class="row g-4">
                            <!-- Tên phòng -->
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control shadow-none @error('roomName') is-invalid @enderror"
                                           id="roomName" name="roomName" value="{{ old('roomName', $screeningroom->roomName) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" min="1" class="form-control shadow-none @error('capacity') is-invalid @enderror"
                                           id="capacity" name="capacity" value="{{ old('capacity', $screeningroom->capacity) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control shadow-none @error('roomType') is-invalid @enderror"
                                           id="roomType" name="roomType" value="{{ old('roomType', $screeningroom->roomType) }}"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select shadow-none @error('isAvailable') is-invalid @enderror"
                                        ...
                                        <option value="yes" {{ old('isAvailable', $screeningroom->isAvailable) == 'yes' ? 'selected' : '' }}>Sẵn sàng</option>
                                        <option value="no" {{ old('isAvailable', $screeningroom->isAvailable) == 'no' ? 'selected' : '' }}>Không sẵn sàng</option>
                                    </select>
                                    @error('isAvailable')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
